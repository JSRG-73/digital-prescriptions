...
public class InfoDialog {
    public static void showInfo(){
        ...
        Text normalText = new Text("Recetario digital desarrollado para el ");
        Text boldName = new Text("Dr. Eduardo Barragán Curiel");
        boldName.setStyle("-fx-font-weight: bold;");

        TextFlow textFlow = new TextFlow(normalText, boldName);

        content.getChildren().addAll(
                textFlow,
                new Text("Versión: 1.5.7"),
                new Text(""),
                ...
                new Text("-Al presionar 'Generar PDF', la receta se guardará y se generará en formato PDF (esto puede tardar unos segundos)"),
                new Text("  con la plantilla de la Unidad de Cancerología. "),
                new Text("-Para ver la carpeta con todos los archivos PDF presione el botón 'Ver Recetas'."),
                ...
                new Text("-Al eliminar una receta NO borrará el archivo PDF, solo no estará disponible para su reutilización."),
